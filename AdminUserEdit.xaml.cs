...
namespace HCI_Projekat
{
    ...
    /// </summary>
    public partial class AdminUserEdit : Window
    {
        Account selected;

        public AdminUserEdit(Account selected)
        {
        ...
        private void button_Copy1_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                AppManager.editAccount(new Account(Role.CLIENT, textBox_name.Text, textBox_email.Text, textBox_phone.Text, textBox_password.Text));
                this.Close();
            }
        }
    }
